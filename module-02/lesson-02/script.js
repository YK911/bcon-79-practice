...
// Роздільник - нижнє підкреслення. Завдання вирішується за допомогою циклу.// Task 1
...
function fn9() {
  ...
  let start = res1 < res2 ? res1 : res2;
  let end   = res1 < res2 ? res2 : res1;
...
function fn10() {
  ...
  for (let age = 1950; age <= 1970; age += 2) {
    result += `${age}_`;
  }
